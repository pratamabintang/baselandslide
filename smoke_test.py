...
def run_smoke_test():
    ...
    # Test plot_results with highlighted metrics
    ...
    print(f"  [OK] plot_results generated results.png with highlighted best metrics")

    passed_tests += 1
    print(colorstr('bright_green', f"--> Test 5 Passed: End-to-end forward/backward/eval cycle & metric plotting verified!"))
